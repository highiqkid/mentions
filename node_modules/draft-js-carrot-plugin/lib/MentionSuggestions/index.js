...
var CarrotSuggestions = function (_Component) {  //ALPHA
  _inherits(CarrotSuggestions, _Component); //ALPHA

  function CarrotSuggestions() { //ALPHA
    var _Object$getPrototypeO;

    var _temp, _this, _ret;

    _classCallCheck(this, CarrotSuggestions); //ALPHA

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(CarrotSuggestions)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      isActive: false,
      ...
      var selectionIsInsideWord = leaves.filter(function (leave) {
        ...
        var end = _ref2.end;
        return start === 0 && anchorOffset === 2 && anchorOffset <= end || // @ is the first character
        anchorOffset > start + 2 //&& anchorOffset <= end // @ is in the text or at the end
        ;
      });
      ...
      var searchValue = word.substring(2, word.length);
  ...
  _createClass(CarrotSuggestions, [{   //ALPHA CHANGE MentionSuggestions to CarrotSuggestions
  ...
  return CarrotSuggestions;
}(_react.Component);

CarrotSuggestions.propTypes = { //ALPHA
  entityMutability: _react.PropTypes.oneOf(['SEGMENTED', 'IMMUTABLE', 'MUTABLE'])
};
exports.default = CarrotSuggestions; //ALPHA
