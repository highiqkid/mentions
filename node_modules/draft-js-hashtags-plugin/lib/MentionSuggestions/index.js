...
var HashtagsSuggestions = function (_Component) {  //ALPHA
  _inherits(HashtagsSuggestions, _Component); //ALPHA

  function HashtagsSuggestions() { //ALPHA
    var _Object$getPrototypeO;

    var _temp, _this, _ret;

    _classCallCheck(this, HashtagsSuggestions); //ALPHA

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(HashtagsSuggestions)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      isActive: false,
  ...
  _createClass(HashtagsSuggestions, [{   //ALPHA CHANGE MentionSuggestions to CarrotSuggestions
  ...
  return HashtagsSuggestions;
}(_react.Component);

HashtagsSuggestions.propTypes = { //ALPHA
  entityMutability: _react.PropTypes.oneOf(['SEGMENTED', 'IMMUTABLE', 'MUTABLE'])
};
exports.default = HashtagsSuggestions; //ALPHA
